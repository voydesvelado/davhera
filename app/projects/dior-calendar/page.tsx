...
export default function DiorCalendarCaseStudy() {
      ...
      <motion.nav initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }} className="fixed top-0 left-0 right-0 z-50 bg-stone-50/80 backdrop-blur-md border-b border-stone-200/50">
        <div className="max-w-5xl mx-auto px-6 sm:px-0 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs text-stone-400 tracking-wider uppercase hidden sm:block">Dior LatAm · Calendar</span>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <SectionTitle>Dior teams need clarity and control when planning launches</SectionTitle>
              <SectionDescription>Through user interviews and observed task flows, we closely analyzed how teams planned and adjusted launches throughout the year. Users consistently struggled with basic operations such as updating dates and understanding launch dependencies.</SectionDescription>
            </div>
            <div className="space-y-3 pt-2 lg:pt-8">
              {["Complete frequent tasks with fewer steps", "Understand where content lives and why", "Work efficiently without leaving the site"].map((text, i) => (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <SectionTitle>Simplifying launch planning with a unified calendar</SectionTitle>
              <SectionDescription>We redesigned the launch calendar to provide a clear, centralized view of all product launches throughout the year. The new interface made it easy to understand recommended dates and apply local adjustments — reducing confusion and enabling teams to plan launches more efficiently across countries.</SectionDescription>
              <StatBadge value={32} label="faster launch planning cycles" />
            </div>
            <BeforeAfter
              src1="/case-studies/dior/solution101.png" alt1="Launch calendar — before"
              src2="/case-studies/dior/solution102.png" alt2="Launch calendar — after"
            />
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <SectionTitle>Enabling flexible updates with a mobile-ready experience</SectionTitle>
              <SectionDescription>To support teams working in dynamic environments, we introduced a fully responsive mobile version of the calendar. Users could review schedules and make updates directly from their mobile devices, ensuring changes could be handled on the go without disrupting workflows.</SectionDescription>
              <StatBadge value={20} label="reduction in coordination-related requests" />
            </div>
            <BeforeAfter
              src1="/case-studies/dior/solution201.png" alt1="Mobile calendar — before"
              src2="/case-studies/dior/solution202.png" alt2="Mobile calendar — after"
            />
          </div>
        </div>
      </Section>

      <CaseStudyFooter title="David Herrera" subtitle="Design Engineer · Dior LatAm Calendar Case Study" ctaLabel="Contact me →" ctaHref="mailto:contactochka@gmail.com" />
    </div>
  );
}
