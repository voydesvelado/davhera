    ...
    <section className="w-full bg-[#0B0B0C] text-white">
      <div className="mx-auto w-full max-w-[1200px] px-8 py-24">
        <div className="max-w-[980px]">
          ...
          >
            Upleveling Dior LatAm’s intranet experience
          </motion.h2>
          ...
          >
            Dior Latin America teams have worked with an intranet that was
            difficult to navigate and slow to use. Information was fragmented,
            key workflows were inefficient, and the interface felt outdated.
            This made everyday work harder than it needed to be. We wanted to
            change that and create a platform that truly supports how teams
            work.
          </motion.p>
        </div>
