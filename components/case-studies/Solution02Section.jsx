        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="flex items-center">
            <div className="max-w-[520px]">
              ...
              >
                Making assets easier to find and reuse
              </motion.h3>
              ...
              >
                We redesigned Dior’s asset repository to help teams find the
                files they need faster. The solution introduced a clearer
                navigation structure and an interface based on familiar patterns
                from tools users already knew. This reduced friction, improved
                confidence, and minimized time spent searching for assets.
              </motion.p>
