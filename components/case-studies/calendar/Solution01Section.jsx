        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="flex items-center">
            <div className="max-w-[520px]">
              ...
              >
                Simplifying launch planning with a unified calendar
              </motion.h3>
              ...
              >
                We redesigned the launch calendar to provide a clear,
                centralized view of all product launches throughout the year.
                The new interface made it easy to understand recommended dates,
                apply local adjustments. This reduced confusion and enabled
                teams to plan launches more efficiently across countries.
              </motion.p>
