        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="flex items-center">
            <div className="max-w-[520px]">
              ...
              >
                To support teams working in dynamic environments, we introduced
                a fully responsive mobile version of the calendar. Users could
                review schedules and make updates directly from their mobile
                devices, ensuring changes could be handled on the go without
