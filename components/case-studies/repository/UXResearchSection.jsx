        ...
        >
          ...
          <div className="flex min-h-[560px] items-center">
            <div className="max-w-[520px]">
              ...
              >
                Dior teams need a fast and intuitive way to access shared assets
              </motion.h2>
              ...
              >
                Through user interviews and observed workflows, we identified
                recurring pain points across roles and countries. Users weren’t
                looking for new features, but for clarity, speed, and confidence
          ...
          <div className="flex min-h-[560px] items-center">
            <motion.div
              ...
              className="relative w-full overflow-hidden rounded-2xl bg-[#E9DFE5] p-10"
            >
              ...
              >
                <InsightCard
                  ...
                  text="Find shared assets quickly and confidently"
                />
                <InsightCard
                  variants={card}
                  transition={{ duration: 0.85, delay: 0.04, ease }}
                  text="Navigate files with clear structure and logic"
                />
                <InsightCard
                  variants={card}
                  transition={{ duration: 0.85, delay: 0.08, ease }}
                  text="Access what they need without extra tools"
                />
              </motion.div>
            </motion.div>
          </div>
