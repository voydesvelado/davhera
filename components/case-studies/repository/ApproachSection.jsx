    ...
    <section className="w-full bg-[#0B0B0C] text-white">
      <div className="mx-auto w-full max-w-[1200px] px-8 py-28">
        <div className="max-w-[980px]">
          ...
          >
            We focused on validating usability before scaling the solution
          </motion.h2>
          ...
          >
            Early concepts were rapidly prototyped and validated with users to
            ensure improvements addressed real needs. Research insights allowed
            us to reduce risk and deliver a solution that measurably improved
            everyday efficiency.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="relative aspect-[16/9] w-full">
            <Image
              src="/case-studies/dior/approach02.png"
