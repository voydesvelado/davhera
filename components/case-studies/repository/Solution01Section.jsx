        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="flex items-center">
            <div className="max-w-[520px]">
              ...
              >
                Rebuilding the information architecture for faster discovery
              </motion.h3>
              ...
              >
                We redesigned the repository structure to make assets easier to
                browse and understand. Content was reorganized based on how
                users search for and reuse files, not on internal system logic.
                Clearer hierarchy and familiar navigation patterns reduced
                cognitive load and helped users locate assets with confidence.
              </motion.p>
          ...
          <div className="flex items-center">
            ...
            >
              <SwapVisual
                src1="/case-studies/dior/solution201.png"
                src2="/case-studies/dior/solution202.png"
